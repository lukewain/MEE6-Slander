...
class MEE6Embed(Embed):
    ...
    def stats_embed(sent, deleted, edited, joined, left, slandered, started, icon_url):
        ...
        embed.add_field(name="Messages Seen", value=sent, inline=False)
        embed.add_field(name="Messages Deleted", value=deleted, inline=False)
        embed.add_field(name="Messages Edited", value=edited, inline=False)
        embed.add_field(name="Servers Joined", value=joined, inline=False)
        embed.add_field(name="Servers Left", value=left, inline=False)
        embed.add_field(name="Times Slandered", value=slandered, inline=False)
        return embed
